package main.java.main.engine.render.gl;
...
public class ShaderProgram {
    ...
    public static int load(String vertexPath, String fragmentPath) {
        ...
        // add old way to pass attributes to shaders because apple fucking sucks.
        GL20.glBindAttribLocation(programId, 0, "inPos");
        GL20.glBindAttribLocation(programId, 1, "inUV");
        GL20.glBindAttribLocation(programId, 2, "inNormal");
